...
*Sinh viên Công nghệ Thông tin | Chuyên ngành An ninh mạng*
...
Trong quá trình học tập, tôi đặc biệt chú trọng vào các kiến thức nền tảng như **mạng máy tính**, **hệ điều hành**, **lập trình** và **các cơ chế bảo mật hệ thống**. Bên cạnh lý thuyết, tôi luôn cố gắng tiếp cận các bài thực hành và demo thực tế nhằm hiểu rõ bản chất vấn đề và nâng cao tư duy phân tích kỹ thuật.
...
Song song đó, tôi rèn luyện kỹ năng lập trình với các ngôn ngữ như **Java**, **JavaScript** và **Python** nhằm phục vụ cho việc phát triển ứng dụng, kiểm thử bảo mật và tự động hóa trong an ninh mạng.
...
- Lập trình Java, JavaScript, Python  
- Phân tích lỗ hổng và thực nghiệm bảo mật  
...
> *“Học đi đôi với hành – bảo mật không chỉ là lý thuyết mà là thực tiễn.”*
